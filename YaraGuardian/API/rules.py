...
urlpatterns = [
    ...
    url(r'^(?P<group_name>\w+)/deconflict/$', RulesetDeconflictView.as_view(), name='ruleset-deconflict'),
    url(r'^(?P<group_name>\w+)/bulk/$', RulesetBulkEditView.as_view(), name='ruleset-bulk'),
    url(r'^(?P<group_name>\w+)/test/$', RulesetTestingView.as_view(), name='ruleset-test'),
